    ...
    steps: [
      {
        ...
        description: 'Check means the King is under direct attack. Move your Rook from d1 to d8 to check the enemy King on e8.',
        ...
        hint: {
          ...
          arrows: [{ startSquare: 'd1', endSquare: 'd8', color: 'rgba(239, 68, 68, 0.9)' }],
        },
    ...
    steps: [
      {
        ...
        description: 'The black King is trapped behind his own pawns. Move your Rook from d1 to d8 to deliver checkmate!',
        ...
        hint: {
          ...
          highlightSquares: ['d1', 'd8'],
          arrows: [{ startSquare: 'd1', endSquare: 'd8', color: 'rgba(212, 175, 55, 0.9)' }],
        },
